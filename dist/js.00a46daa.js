...
},{"core-js/shim":"../node_modules/core-js/shim.js","regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"../node_modules/core-js/fn/regexp/escape.js"}],"js/home.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.video = exports.arrivalItem = exports.collection = exports.card = exports.showcase = exports.menuOverlay = exports.appWrapper = exports.menuClose = exports.hamburger = exports.navbar = void 0;
...
var arrivalItem = document.querySelectorAll('.arrival__item');
exports.arrivalItem = arrivalItem;
...
window.addEventListener('scroll', function () {
  ...
  if (collection) if (pageYOffset >= 600) {
  ...
  if (pageYOffset >= 900) {
    arrivalItem.forEach(function (item) {
...
var page = document.querySelector('[name=page]');
minus.forEach(function (item) {
  item.addEventListener('click', function () {
    var filter = item.parentNode.nextElementSibling;
...
var APICalls = function APICalls() {
  ...
  _defineProperty(this, "pagination", function (Num) {
    fetch("http://127.0.0.1:4500/api/v1/products?limit=8&page=".concat(Num)).then(function (res) {
      return res.json();
    }).then(function (data) {
  ...
  _defineProperty(this, "createQueryStr", function () {
    var query = [];
    inputs.forEach(function (input) {
      if (input.checked) {
        ...
        if (input.name === 'price' && input.id === 'lte') {
          operator = 'lte';
          console.log("".concat(input.name, "[").concat(operator, "]=").concat(input.value, "&"));
          query.push("".concat(input.name, "[").concat(operator, "]=").concat(input.value, "&"));
          ...
          query.push("".concat(input.name, "=").concat(input.value, "&"));
        }
      }
    });
    _this.queryStr = query.join('');
  });

  _defineProperty(this, "showInitialProducts", function () {
  ...
  _defineProperty(this, "getProducts", function () {
    fetch("".concat(_this.url, "&").concat(_this.queryStr)).then(function (res) {
      return res.json();
    }).then(function (Data) {
      console.log(Data);
...
var FetchProducts = new APICalls();
inputs.forEach(function (filterItem) {
...
var home = _interopRequireWildcard(require("./home.js"));

var products = _interopRequireWildcard(require("./products"));
...
},{"babel-polyfill":"../node_modules/babel-polyfill/lib/index.js","./home.js":"js/home.js","./products":"js/products.js"}],"C:/Users/HARI/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["C:/Users/HARI/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/index.js"], null)
